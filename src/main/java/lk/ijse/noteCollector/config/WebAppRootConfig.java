...
@EnableJpaRepositories(basePackages = "lk.ijse.noteCollector.dao")
@EnableTransactionManagement
public class WebAppRootConfig {
    //methanat bean dnne meka method level ekk nisa
    @Bean
    ...
    public DataSource dataSource() {
        ...
        driverManagerDataSource.setUrl("jdbc:mysql://localhost:3306/noteCollector?createDatabaseIfNotExist=true");
